...
from .simple_example_soft_policy import SimpleExampleSoftPolicy
...
class PolicyDrawer(GridDrawer):
    ...
    def __init__(self, policy: SimpleExampleSoftPolicy, maximum_grid_drawer_window_height_in_pixels: int,
